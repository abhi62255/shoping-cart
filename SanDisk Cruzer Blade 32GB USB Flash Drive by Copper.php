	...
	<!-- <form action="selected.php" method="post">
		...
		<div style="background-color:#FFFFFF;">
			<div style=" float:left; height:520px; width:520px;">
				<img src="images/71Q8QsmuSAL._SL1417_.jpg";  style="width: 250px;height: 335px;margin-left:80px;margin-top:20px;" />
			</div>
			<div style="float:right; height:600px; width:700px;">
				<h2>SanDisk Cruzer Blade 32GB USB Flash Drive</h2><hr color="#CCCCCC" style="margin-top:-15px;" />
				<p>
					<span style="color:#999999; font-size: small; padding-left: 20px; ">M.R.P.:&#x20b9;<strike>990.00</strike></span><br />
					<span style="color:#999999; font-size: small; padding-left: 30px;">Price:</span><span style="color:#B12704; font-size: larger;"> &#x20b9;718.00</span><span style="font-weight:bold; font-size: medium; font-family: monospace;">&nbsp;&nbsp;FREE Delivery</span><br />
					<span style="color:#999999; font-size: small;">You Save:</span>	<span style="color:#B12704; font-size: small;">&#x20b9;272.00 (27%)</span><br />
				...
				<ul style="padding:10px; font-weight:bold;">
					<li style="padding:5px;">Ultra-compact and portable USB flash drive</li>	
					<li style="padding:5px;">Share your photos, videos, songs and other files between computers with ease</li>
					<li style="padding:5px;">Protect your private files with included SanDisk SecureAccess software</li>
					<li style="padding:5px;">Includes added protection of secure online backup (up to 2GB optionally available) offered by YuuWaa</li>
					<li style="padding:5px;">Password-protect your sensitive files</li>	
					<li style="padding:5px;">Capless design</li>	
...
<div style="height:292px; background-color:#FFFFFF; width: 1247px; margin-top: -390px;">
	<p>
		<span style="color:#C60; font-weight:bold; padding-left:20px;">SanDisk Cruzer Blade 32GB USB Pen Drive Information</span><br>
	...
	<table border="1" style="border-collapse:collapse;">
		<tr><th>BRAND</th><td>SanDisk</td><th>Item model number</th><td>SDCZ50-032G-B35</td></tr>
		<tr><th>SERIES</th><td>Ammo</td><th>RAM Size</th><td>32 GB</td></tr>
		<tr><th>color</th><td>Red-Black</td><th>Hardware Platform</th><td>PC, Mac</td></tr>
		<tr><th>Item Height</th><td>41 Millimeters</td><th>Operating System</th><td>Support All Operating System</td></tr>
		<tr><th>Item Width</th><td>18 Millimeters</td><th>Product Dimensions</th><td>73.7 x 1.8 x 4.1 cm</td></tr>
	</table>
</div>
