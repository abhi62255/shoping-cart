	...
	<!-- <form action="selected.php" method="post">
		...
		<div style="background-color:#FFFFFF;">
			<div style=" float:left; height:520px; width:520px;">
				<img src="images/71XKYg966RL._SL1500_.jpg";  style="width: 418px;height: 266px;margin-left: 42px;margin-top: 62px;" />
			</div>
			<div style="float:right; height:600px; width:700px;">
				<h2>Omen by HP - AX250TX - 15.6-inch Laptop (7th Gen Core i7-7700/16GB/1TB + 128 GB SSD /Nvidia GeForce 1050 TX GTX 4GB Graphics/ Windows 10 Home), Black With  MS Office 2016 H & S edition</h2><hr color="#CCCCCC" style="margin-top:-15px;" />
				<p>
					<span style="color:#999999; font-size: small; padding-left: 20px; ">M.R.P.:&#x20b9;<strike>166,047.00</strike></span><br />
					<span style="color:#999999; font-size: small; padding-left: 30px;">Price:</span><span style="color:#B12704; font-size: larger;"> &#x20b9;106,990.00</span><span style="font-weight:bold; font-size: medium; font-family: monospace;">&nbsp;&nbsp;FREE Delivery</span><br />
					...
					<span style="font-weight:bold; font-family: monospace;">EMI</span> starts at &#x20b9; 5,087. No Cost EMI available if you checkout only with this item.<span style="font-family: monospace;"></span><br />
				...
				<ul style="padding:10px; font-weight:bold;">
					<li style="padding:5px;">3.6GHz Intel Core i7-7700 7th Gen processor</li>	
					<li style="padding:5px;">16GB DDR4 RAM</li>
					<li style="padding:5px;">1TB 7200rpm Serial ATA hard drive + 128 GB SSD</li>
					<li style="padding:5px;">15.6-inch screen, Nvidia GeForce 1050Ti GTX 4GB Graphics</li>
					<li style="padding:5px;">Windows 10 Home operating system</li>	
					<li style="padding:5px;">Black with carbon fiber finish</li>				
				</ul>
				</p>
			</div>
...
<div style="height:292px; background-color:#FFFFFF; width: 1247px; margin-top: -390px;">
	<p>
		<span style="color:#C60; font-weight:bold; padding-left:20px;">Omen by HP - AX250TX - 15.6-inch Laptop Information</span><br>
	...
	<table border="1" style="border-collapse:collapse;">
		...
		<tr><th>Series</th><td>MacBook Pro</td><th>Screen Size</th><td>15.6 Inches</td></tr>
		...
		<tr><th>RAM Size</th><td>16 GB</td><th>Item Weight</th><td>3.6 KG</td></tr>
